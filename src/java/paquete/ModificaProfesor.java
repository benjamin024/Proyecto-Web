...
public class ModificaProfesor extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ModificaProfesor.class.getName()).log(Level.SEVERE, null, ex);
        }
         ...
         out.println("<!DOCTYPE html>");
           ...
           out.println("<a href='profesor' class='navbar-logo'><img src='utilities/images/logoescom-182x128-95.png'></a>");
            ...
            out.println("<li class='nav-item'><a class='nav-link link' href='ModificaProfesor' aria-expanded='false'  style='color: #FFFFFF;'>Modificar</a></li>");
         ...
         out.println("   <div class='row'>");
              out.println("   <div class='mbr-section col-md-10 col-md-offset-1 text-xs-center'>");
                   out.println("  <h1 class='mbr-section-title display-1'>¡Actualiza los datos!</h1>");
                    ...
                    out.println(" <form action='actualizaProfesor' method='post' class='form'>");
