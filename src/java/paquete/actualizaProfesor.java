...
public class actualizaProfesor extends HttpServlet {
    
    private String rutaXML;
    
    public boolean modificar(String nom, String grup, String user, String email, String pass) throws Exception{
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            ...
            try {
                boolean ok = modificar(nombre, grupo, user, mail, pass);
                if(ok){
